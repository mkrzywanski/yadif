...
import io.mkrzywanski.yadif.test.EmptyConfig;
...
class YadifTest {
    ...
    void shouldInitializeContext() {
        ...
        final var instance = context.getInstanceOptional("java.lang.Object", Object.class);
    ...
    void shouldInitializeContextWithConfigContainingDependencies() {
        ...
        final var a = context.getInstanceOptional("io.mkrzywanski.yadif.test.A", A.class);
        final var b = context.getInstanceOptional("io.mkrzywanski.yadif.test.B", B.class);
        final var c = context.getInstanceOptional("io.mkrzywanski.yadif.test.C", C.class);
    ...
    void shouldInstantiateSimplePackagedScannedBeans() {
        ...
        final var a = context.getInstanceOptional("io.mkrzywanski.yadif.test.packagescan.simple.components.A", io.mkrzywanski.yadif.test.packagescan.simple.components.A.class);
        final var b = context.getInstanceOptional("io.mkrzywanski.yadif.test.packagescan.simple.components.B", io.mkrzywanski.yadif.test.packagescan.simple.components.B.class);
    ...
    void shouldInstantiateBeansWhenUsingPackageScanAndConfigInstances() {
        ...
        final var a = context.getInstanceOptional("io.mkrzywanski.yadif.test.packagescan.mixed.A", io.mkrzywanski.yadif.test.packagescan.mixed.A.class);
        final var b = context.getInstanceOptional("io.mkrzywanski.yadif.test.packagescan.mixed.component.B", io.mkrzywanski.yadif.test.packagescan.mixed.component.B.class);
    ...
    void shouldInstantiateBeansWhenUsingPackageScanAndOneBeanHasMultipleConstructors() {
        ...
        final var a = context.getInstanceOptional("io.mkrzywanski.yadif.test.packagescan.multipleconstructors.component.A", io.mkrzywanski.yadif.test.packagescan.multipleconstructors.component.A.class);
        final var b = context.getInstanceOptional("io.mkrzywanski.yadif.test.packagescan.multipleconstructors.component.B", io.mkrzywanski.yadif.test.packagescan.multipleconstructors.component.B.class);
    ...
    @Test
    void shouldNotFailForEmptyConfig() {
        final ThrowableAssert.ThrowingCallable code = () -> Yadif.fromConfig(EmptyConfig.class);
        assertThatCode(code).doesNotThrowAnyException();
    }

    @Test
    void shouldThrowExceptionWhenNoBeanDefinitionIsFound() {
        final Context context = Yadif.fromConfig(new DummyConfig());
        final ThrowableAssert.ThrowingCallable code = () -> context.getInstance("java.lang.NonExistingClass", Object.class);

        assertThatCode(code).isExactlyInstanceOf(NoSuchBeanException.class);
    }
